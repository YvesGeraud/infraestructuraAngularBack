...
import type {
  ...
  ct_infraestructura_almacenamiento_aguaId,
} from "./ct_infraestructura_almacenamiento_agua";
import type {
  ct_infraestructura_antiguedad_inmueble,
  ct_infraestructura_antiguedad_inmuebleId,
} from "./ct_infraestructura_antiguedad_inmueble";
import type {
  ct_infraestructura_construccion_inmueble,
  ct_infraestructura_construccion_inmuebleId,
} from "./ct_infraestructura_construccion_inmueble";
import type {
  ct_infraestructura_dimension_terreno,
  ct_infraestructura_dimension_terrenoId,
} from "./ct_infraestructura_dimension_terreno";
import type {
  ct_infraestructura_edificio,
  ct_infraestructura_edificioId,
} from "./ct_infraestructura_edificio";
import type {
  ct_infraestructura_equipo_discapacidad,
  ct_infraestructura_equipo_discapacidadId,
} from "./ct_infraestructura_equipo_discapacidad";
import type {
  ct_infraestructura_espacio_inmueble,
  ct_infraestructura_espacio_inmuebleId,
} from "./ct_infraestructura_espacio_inmueble";
import type {
  ct_infraestructura_fin_inmueble,
  ct_infraestructura_fin_inmuebleId,
} from "./ct_infraestructura_fin_inmueble";
import type {
  ct_infraestructura_frecuencia_limpieza,
  ct_infraestructura_frecuencia_limpiezaId,
} from "./ct_infraestructura_frecuencia_limpieza";
import type {
  ct_infraestructura_obra_mantenimiento,
  ct_infraestructura_obra_mantenimientoId,
} from "./ct_infraestructura_obra_mantenimiento";
import type {
  ct_infraestructura_razon_no_construccion,
  ct_infraestructura_razon_no_construccionId,
} from "./ct_infraestructura_razon_no_construccion";
import type {
  ct_infraestructura_suministro_agua,
  ct_infraestructura_suministro_aguaId,
} from "./ct_infraestructura_suministro_agua";
import type {
  ct_infraestructura_suministro_energia,
  ct_infraestructura_suministro_energiaId,
} from "./ct_infraestructura_suministro_energia";
import type {
  ct_infraestructura_suministro_gas,
  ct_infraestructura_suministro_gasId,
} from "./ct_infraestructura_suministro_gas";
import type {
  ct_infraestructura_tipo_construccion,
  ct_infraestructura_tipo_construccionId,
} from "./ct_infraestructura_tipo_construccion";
import type {
  ct_infraestructura_tipo_descarga,
  ct_infraestructura_tipo_descargaId,
} from "./ct_infraestructura_tipo_descarga";
import type { ct_usuario, ct_usuarioId } from "./ct_usuario";
import type {
  rl_infraestructura_unidad_almacenamiento_agua,
  rl_infraestructura_unidad_almacenamiento_aguaId,
} from "./rl_infraestructura_unidad_almacenamiento_agua";
import type {
  rl_infraestructura_unidad_construccion,
  rl_infraestructura_unidad_construccionId,
} from "./rl_infraestructura_unidad_construccion";
import type {
  rl_infraestructura_unidad_construccion_inmueble,
  rl_infraestructura_unidad_construccion_inmuebleId,
} from "./rl_infraestructura_unidad_construccion_inmueble";
import type {
  rl_infraestructura_unidad_equipo_discapacidad,
  rl_infraestructura_unidad_equipo_discapacidadId,
} from "./rl_infraestructura_unidad_equipo_discapacidad";
import type {
  rl_infraestructura_unidad_espacio_inmueble,
  rl_infraestructura_unidad_espacio_inmuebleId,
} from "./rl_infraestructura_unidad_espacio_inmueble";
import type {
  rl_infraestructura_unidad_espacios_educativos,
  rl_infraestructura_unidad_espacios_educativosId,
} from "./rl_infraestructura_unidad_espacios_educativos";
import type {
  rl_infraestructura_unidad_fin_inmueble,
  rl_infraestructura_unidad_fin_inmuebleId,
} from "./rl_infraestructura_unidad_fin_inmueble";
import type {
  rl_infraestructura_unidad_obra_mantenimiento,
  rl_infraestructura_unidad_obra_mantenimientoId,
} from "./rl_infraestructura_unidad_obra_mantenimiento";
...
export interface ct_infraestructura_unidadAttributes {
  ...
  existe_almacenamiento_agua?: number;
  ...
  tazas_mixtos?: number;
  mingitorios_hombres?: number;
  mingitorios_mujeres?: number;
  mingitorios_mixtos?: number;
  letrinas_hombres?: number;
  letrinas_mujeres?: number;
  letrinas_mixtos?: number;
  tazas_docadm?: number;
  tazas_ambos?: number;
  ...
  rutas_evac_existentes?: number;
  rutas_evac_uso?: number;
...
export type ct_infraestructura_unidadId =
  ct_infraestructura_unidad[ct_infraestructura_unidadPk];
export type ct_infraestructura_unidadOptionalAttributes =
  | "id_unidad"
  | "calle"
  | "numero_exterior"
  | "numero_interior"
...
export type ct_infraestructura_unidadCreationAttributes = Optional<
  ct_infraestructura_unidadAttributes,
  ct_infraestructura_unidadOptionalAttributes
>;

export class ct_infraestructura_unidad
  extends Model<
    ct_infraestructura_unidadAttributes,
    ct_infraestructura_unidadCreationAttributes
  >
  implements ct_infraestructura_unidadAttributes
{
  id_unidad!: number;
  cct!: string;
  nombre_unidad!: string;
  ...
  setId_antiguedad_inmueble_ct_infraestructura_antiguedad_inmueble!: Sequelize.BelongsToSetAssociationMixin<
    ct_infraestructura_antiguedad_inmueble,
    ct_infraestructura_antiguedad_inmuebleId
  >;
  ...
  setId_dimension_terreno_ct_infraestructura_dimension_terreno!: Sequelize.BelongsToSetAssociationMixin<
    ct_infraestructura_dimension_terreno,
    ct_infraestructura_dimension_terrenoId
  >;
  ...
  setId_frecuencia_limpieza_ct_infraestructura_frecuencia_limpieza!: Sequelize.BelongsToSetAssociationMixin<
    ct_infraestructura_frecuencia_limpieza,
    ct_infraestructura_frecuencia_limpiezaId
  >;
  ...
  setId_razon_no_construccion_ct_infraestructura_razon_no_construccion!: Sequelize.BelongsToSetAssociationMixin<
    ct_infraestructura_razon_no_construccion,
    ct_infraestructura_razon_no_construccionId
  >;
  ...
  // ct_infraestructura_unidad belongsTo ct_infraestructura_suministro_agua via id_suministro_agua
  ...
  setId_suministro_agua_ct_infraestructura_suministro_agua!: Sequelize.BelongsToSetAssociationMixin<
    ct_infraestructura_suministro_agua,
    ct_infraestructura_suministro_aguaId
  >;
  ...
  setId_suministro_energia_ct_infraestructura_suministro_energium!: Sequelize.BelongsToSetAssociationMixin<
    ct_infraestructura_suministro_energia,
    ct_infraestructura_suministro_energiaId
  >;
  ...
  setId_suministro_gas_ct_infraestructura_suministro_ga!: Sequelize.BelongsToSetAssociationMixin<
    ct_infraestructura_suministro_gas,
    ct_infraestructura_suministro_gasId
  >;
  ...
  setId_tipo_descarga_ct_infraestructura_tipo_descarga!: Sequelize.BelongsToSetAssociationMixin<
    ct_infraestructura_tipo_descarga,
    ct_infraestructura_tipo_descargaId
  >;
  ...
  setId_almacenamiento_ct_infraestructura_almacenamiento_aguas!: Sequelize.BelongsToManySetAssociationsMixin<
    ct_infraestructura_almacenamiento_agua,
    ct_infraestructura_almacenamiento_aguaId
  >;
  addId_almacenamiento_ct_infraestructura_almacenamiento_agua!: Sequelize.BelongsToManyAddAssociationMixin<
    ct_infraestructura_almacenamiento_agua,
    ct_infraestructura_almacenamiento_aguaId
  >;
  addId_almacenamiento_ct_infraestructura_almacenamiento_aguas!: Sequelize.BelongsToManyAddAssociationsMixin<
    ct_infraestructura_almacenamiento_agua,
    ct_infraestructura_almacenamiento_aguaId
  >;
  ...
  removeId_almacenamiento_ct_infraestructura_almacenamiento_agua!: Sequelize.BelongsToManyRemoveAssociationMixin<
    ct_infraestructura_almacenamiento_agua,
    ct_infraestructura_almacenamiento_aguaId
  >;
  removeId_almacenamiento_ct_infraestructura_almacenamiento_aguas!: Sequelize.BelongsToManyRemoveAssociationsMixin<
    ct_infraestructura_almacenamiento_agua,
    ct_infraestructura_almacenamiento_aguaId
  >;
  hasId_almacenamiento_ct_infraestructura_almacenamiento_agua!: Sequelize.BelongsToManyHasAssociationMixin<
    ct_infraestructura_almacenamiento_agua,
    ct_infraestructura_almacenamiento_aguaId
  >;
  hasId_almacenamiento_ct_infraestructura_almacenamiento_aguas!: Sequelize.BelongsToManyHasAssociationsMixin<
    ct_infraestructura_almacenamiento_agua,
    ct_infraestructura_almacenamiento_aguaId
  >;
  ...
  setId_construccion_ct_infraestructura_construccion_inmuebles!: Sequelize.BelongsToManySetAssociationsMixin<
    ct_infraestructura_construccion_inmueble,
    ct_infraestructura_construccion_inmuebleId
  >;
  addId_construccion_ct_infraestructura_construccion_inmueble!: Sequelize.BelongsToManyAddAssociationMixin<
    ct_infraestructura_construccion_inmueble,
    ct_infraestructura_construccion_inmuebleId
  >;
  addId_construccion_ct_infraestructura_construccion_inmuebles!: Sequelize.BelongsToManyAddAssociationsMixin<
    ct_infraestructura_construccion_inmueble,
    ct_infraestructura_construccion_inmuebleId
  >;
  ...
  removeId_construccion_ct_infraestructura_construccion_inmueble!: Sequelize.BelongsToManyRemoveAssociationMixin<
    ct_infraestructura_construccion_inmueble,
    ct_infraestructura_construccion_inmuebleId
  >;
  removeId_construccion_ct_infraestructura_construccion_inmuebles!: Sequelize.BelongsToManyRemoveAssociationsMixin<
    ct_infraestructura_construccion_inmueble,
    ct_infraestructura_construccion_inmuebleId
  >;
  hasId_construccion_ct_infraestructura_construccion_inmueble!: Sequelize.BelongsToManyHasAssociationMixin<
    ct_infraestructura_construccion_inmueble,
    ct_infraestructura_construccion_inmuebleId
  >;
  hasId_construccion_ct_infraestructura_construccion_inmuebles!: Sequelize.BelongsToManyHasAssociationsMixin<
    ct_infraestructura_construccion_inmueble,
    ct_infraestructura_construccion_inmuebleId
  >;
  ...
  setCt_infraestructura_edificios!: Sequelize.HasManySetAssociationsMixin<
    ct_infraestructura_edificio,
    ct_infraestructura_edificioId
  >;
  addCt_infraestructura_edificio!: Sequelize.HasManyAddAssociationMixin<
    ct_infraestructura_edificio,
    ct_infraestructura_edificioId
  >;
  addCt_infraestructura_edificios!: Sequelize.HasManyAddAssociationsMixin<
    ct_infraestructura_edificio,
    ct_infraestructura_edificioId
  >;
  createCt_infraestructura_edificio!: Sequelize.HasManyCreateAssociationMixin<ct_infraestructura_edificio>;
  removeCt_infraestructura_edificio!: Sequelize.HasManyRemoveAssociationMixin<
    ct_infraestructura_edificio,
    ct_infraestructura_edificioId
  >;
  removeCt_infraestructura_edificios!: Sequelize.HasManyRemoveAssociationsMixin<
    ct_infraestructura_edificio,
    ct_infraestructura_edificioId
  >;
  hasCt_infraestructura_edificio!: Sequelize.HasManyHasAssociationMixin<
    ct_infraestructura_edificio,
    ct_infraestructura_edificioId
  >;
  hasCt_infraestructura_edificios!: Sequelize.HasManyHasAssociationsMixin<
    ct_infraestructura_edificio,
    ct_infraestructura_edificioId
  >;
  ...
  setId_equipo_ct_infraestructura_equipo_discapacidads!: Sequelize.BelongsToManySetAssociationsMixin<
    ct_infraestructura_equipo_discapacidad,
    ct_infraestructura_equipo_discapacidadId
  >;
  addId_equipo_ct_infraestructura_equipo_discapacidad!: Sequelize.BelongsToManyAddAssociationMixin<
    ct_infraestructura_equipo_discapacidad,
    ct_infraestructura_equipo_discapacidadId
  >;
  addId_equipo_ct_infraestructura_equipo_discapacidads!: Sequelize.BelongsToManyAddAssociationsMixin<
    ct_infraestructura_equipo_discapacidad,
    ct_infraestructura_equipo_discapacidadId
  >;
  ...
  removeId_equipo_ct_infraestructura_equipo_discapacidad!: Sequelize.BelongsToManyRemoveAssociationMixin<
    ct_infraestructura_equipo_discapacidad,
    ct_infraestructura_equipo_discapacidadId
  >;
  removeId_equipo_ct_infraestructura_equipo_discapacidads!: Sequelize.BelongsToManyRemoveAssociationsMixin<
    ct_infraestructura_equipo_discapacidad,
    ct_infraestructura_equipo_discapacidadId
  >;
  hasId_equipo_ct_infraestructura_equipo_discapacidad!: Sequelize.BelongsToManyHasAssociationMixin<
    ct_infraestructura_equipo_discapacidad,
    ct_infraestructura_equipo_discapacidadId
  >;
  hasId_equipo_ct_infraestructura_equipo_discapacidads!: Sequelize.BelongsToManyHasAssociationsMixin<
    ct_infraestructura_equipo_discapacidad,
    ct_infraestructura_equipo_discapacidadId
  >;
  ...
  setId_espacio_ct_infraestructura_espacio_inmuebles!: Sequelize.BelongsToManySetAssociationsMixin<
    ct_infraestructura_espacio_inmueble,
    ct_infraestructura_espacio_inmuebleId
  >;
  addId_espacio_ct_infraestructura_espacio_inmueble!: Sequelize.BelongsToManyAddAssociationMixin<
    ct_infraestructura_espacio_inmueble,
    ct_infraestructura_espacio_inmuebleId
  >;
  addId_espacio_ct_infraestructura_espacio_inmuebles!: Sequelize.BelongsToManyAddAssociationsMixin<
    ct_infraestructura_espacio_inmueble,
    ct_infraestructura_espacio_inmuebleId
  >;
  ...
  removeId_espacio_ct_infraestructura_espacio_inmueble!: Sequelize.BelongsToManyRemoveAssociationMixin<
    ct_infraestructura_espacio_inmueble,
    ct_infraestructura_espacio_inmuebleId
  >;
  removeId_espacio_ct_infraestructura_espacio_inmuebles!: Sequelize.BelongsToManyRemoveAssociationsMixin<
    ct_infraestructura_espacio_inmueble,
    ct_infraestructura_espacio_inmuebleId
  >;
  hasId_espacio_ct_infraestructura_espacio_inmueble!: Sequelize.BelongsToManyHasAssociationMixin<
    ct_infraestructura_espacio_inmueble,
    ct_infraestructura_espacio_inmuebleId
  >;
  hasId_espacio_ct_infraestructura_espacio_inmuebles!: Sequelize.BelongsToManyHasAssociationsMixin<
    ct_infraestructura_espacio_inmueble,
    ct_infraestructura_espacio_inmuebleId
  >;
  ...
  setId_fin_ct_infraestructura_fin_inmuebles!: Sequelize.BelongsToManySetAssociationsMixin<
    ct_infraestructura_fin_inmueble,
    ct_infraestructura_fin_inmuebleId
  >;
  addId_fin_ct_infraestructura_fin_inmueble!: Sequelize.BelongsToManyAddAssociationMixin<
    ct_infraestructura_fin_inmueble,
    ct_infraestructura_fin_inmuebleId
  >;
  addId_fin_ct_infraestructura_fin_inmuebles!: Sequelize.BelongsToManyAddAssociationsMixin<
    ct_infraestructura_fin_inmueble,
    ct_infraestructura_fin_inmuebleId
  >;
  ...
  removeId_fin_ct_infraestructura_fin_inmueble!: Sequelize.BelongsToManyRemoveAssociationMixin<
    ct_infraestructura_fin_inmueble,
    ct_infraestructura_fin_inmuebleId
  >;
  removeId_fin_ct_infraestructura_fin_inmuebles!: Sequelize.BelongsToManyRemoveAssociationsMixin<
    ct_infraestructura_fin_inmueble,
    ct_infraestructura_fin_inmuebleId
  >;
  hasId_fin_ct_infraestructura_fin_inmueble!: Sequelize.BelongsToManyHasAssociationMixin<
    ct_infraestructura_fin_inmueble,
    ct_infraestructura_fin_inmuebleId
  >;
  hasId_fin_ct_infraestructura_fin_inmuebles!: Sequelize.BelongsToManyHasAssociationsMixin<
    ct_infraestructura_fin_inmueble,
    ct_infraestructura_fin_inmuebleId
  >;
  ...
  setId_obra_ct_infraestructura_obra_mantenimientos!: Sequelize.BelongsToManySetAssociationsMixin<
    ct_infraestructura_obra_mantenimiento,
    ct_infraestructura_obra_mantenimientoId
  >;
  addId_obra_ct_infraestructura_obra_mantenimiento!: Sequelize.BelongsToManyAddAssociationMixin<
    ct_infraestructura_obra_mantenimiento,
    ct_infraestructura_obra_mantenimientoId
  >;
  addId_obra_ct_infraestructura_obra_mantenimientos!: Sequelize.BelongsToManyAddAssociationsMixin<
    ct_infraestructura_obra_mantenimiento,
    ct_infraestructura_obra_mantenimientoId
  >;
  ...
  removeId_obra_ct_infraestructura_obra_mantenimiento!: Sequelize.BelongsToManyRemoveAssociationMixin<
    ct_infraestructura_obra_mantenimiento,
    ct_infraestructura_obra_mantenimientoId
  >;
  removeId_obra_ct_infraestructura_obra_mantenimientos!: Sequelize.BelongsToManyRemoveAssociationsMixin<
    ct_infraestructura_obra_mantenimiento,
    ct_infraestructura_obra_mantenimientoId
  >;
  hasId_obra_ct_infraestructura_obra_mantenimiento!: Sequelize.BelongsToManyHasAssociationMixin<
    ct_infraestructura_obra_mantenimiento,
    ct_infraestructura_obra_mantenimientoId
  >;
  hasId_obra_ct_infraestructura_obra_mantenimientos!: Sequelize.BelongsToManyHasAssociationsMixin<
    ct_infraestructura_obra_mantenimiento,
    ct_infraestructura_obra_mantenimientoId
  >;
  ...
  setId_construccion_ct_infraestructura_tipo_construccions!: Sequelize.BelongsToManySetAssociationsMixin<
    ct_infraestructura_tipo_construccion,
    ct_infraestructura_tipo_construccionId
  >;
  addId_construccion_ct_infraestructura_tipo_construccion!: Sequelize.BelongsToManyAddAssociationMixin<
    ct_infraestructura_tipo_construccion,
    ct_infraestructura_tipo_construccionId
  >;
  addId_construccion_ct_infraestructura_tipo_construccions!: Sequelize.BelongsToManyAddAssociationsMixin<
    ct_infraestructura_tipo_construccion,
    ct_infraestructura_tipo_construccionId
  >;
  ...
  removeId_construccion_ct_infraestructura_tipo_construccion!: Sequelize.BelongsToManyRemoveAssociationMixin<
    ct_infraestructura_tipo_construccion,
    ct_infraestructura_tipo_construccionId
  >;
  removeId_construccion_ct_infraestructura_tipo_construccions!: Sequelize.BelongsToManyRemoveAssociationsMixin<
    ct_infraestructura_tipo_construccion,
    ct_infraestructura_tipo_construccionId
  >;
  hasId_construccion_ct_infraestructura_tipo_construccion!: Sequelize.BelongsToManyHasAssociationMixin<
    ct_infraestructura_tipo_construccion,
    ct_infraestructura_tipo_construccionId
  >;
  hasId_construccion_ct_infraestructura_tipo_construccions!: Sequelize.BelongsToManyHasAssociationsMixin<
    ct_infraestructura_tipo_construccion,
    ct_infraestructura_tipo_construccionId
  >;
  countId_construccion_ct_infraestructura_tipo_construccions!: Sequelize.BelongsToManyCountAssociationsMixin;
  // ct_infraestructura_unidad hasMany ct_usuario via id_unidad
  ct_usuarios!: ct_usuario[];
  getCt_usuarios!: Sequelize.HasManyGetAssociationsMixin<ct_usuario>;
  setCt_usuarios!: Sequelize.HasManySetAssociationsMixin<
    ct_usuario,
    ct_usuarioId
  >;
  addCt_usuario!: Sequelize.HasManyAddAssociationMixin<
    ct_usuario,
    ct_usuarioId
  >;
  addCt_usuarios!: Sequelize.HasManyAddAssociationsMixin<
    ct_usuario,
    ct_usuarioId
  >;
  createCt_usuario!: Sequelize.HasManyCreateAssociationMixin<ct_usuario>;
  removeCt_usuario!: Sequelize.HasManyRemoveAssociationMixin<
    ct_usuario,
    ct_usuarioId
  >;
  removeCt_usuarios!: Sequelize.HasManyRemoveAssociationsMixin<
    ct_usuario,
    ct_usuarioId
  >;
  hasCt_usuario!: Sequelize.HasManyHasAssociationMixin<
    ct_usuario,
    ct_usuarioId
  >;
  hasCt_usuarios!: Sequelize.HasManyHasAssociationsMixin<
    ct_usuario,
    ct_usuarioId
  >;
  countCt_usuarios!: Sequelize.HasManyCountAssociationsMixin;
  ...
  setRl_infraestructura_unidad_almacenamiento_aguas!: Sequelize.HasManySetAssociationsMixin<
    rl_infraestructura_unidad_almacenamiento_agua,
    rl_infraestructura_unidad_almacenamiento_aguaId
  >;
  addRl_infraestructura_unidad_almacenamiento_agua!: Sequelize.HasManyAddAssociationMixin<
    rl_infraestructura_unidad_almacenamiento_agua,
    rl_infraestructura_unidad_almacenamiento_aguaId
  >;
  addRl_infraestructura_unidad_almacenamiento_aguas!: Sequelize.HasManyAddAssociationsMixin<
    rl_infraestructura_unidad_almacenamiento_agua,
    rl_infraestructura_unidad_almacenamiento_aguaId
  >;
  ...
  removeRl_infraestructura_unidad_almacenamiento_agua!: Sequelize.HasManyRemoveAssociationMixin<
    rl_infraestructura_unidad_almacenamiento_agua,
    rl_infraestructura_unidad_almacenamiento_aguaId
  >;
  removeRl_infraestructura_unidad_almacenamiento_aguas!: Sequelize.HasManyRemoveAssociationsMixin<
    rl_infraestructura_unidad_almacenamiento_agua,
    rl_infraestructura_unidad_almacenamiento_aguaId
  >;
  hasRl_infraestructura_unidad_almacenamiento_agua!: Sequelize.HasManyHasAssociationMixin<
    rl_infraestructura_unidad_almacenamiento_agua,
    rl_infraestructura_unidad_almacenamiento_aguaId
  >;
  hasRl_infraestructura_unidad_almacenamiento_aguas!: Sequelize.HasManyHasAssociationsMixin<
    rl_infraestructura_unidad_almacenamiento_agua,
    rl_infraestructura_unidad_almacenamiento_aguaId
  >;
  ...
  setRl_infraestructura_unidad_construccions!: Sequelize.HasManySetAssociationsMixin<
    rl_infraestructura_unidad_construccion,
    rl_infraestructura_unidad_construccionId
  >;
  addRl_infraestructura_unidad_construccion!: Sequelize.HasManyAddAssociationMixin<
    rl_infraestructura_unidad_construccion,
    rl_infraestructura_unidad_construccionId
  >;
  addRl_infraestructura_unidad_construccions!: Sequelize.HasManyAddAssociationsMixin<
    rl_infraestructura_unidad_construccion,
    rl_infraestructura_unidad_construccionId
  >;
  ...
  removeRl_infraestructura_unidad_construccion!: Sequelize.HasManyRemoveAssociationMixin<
    rl_infraestructura_unidad_construccion,
    rl_infraestructura_unidad_construccionId
  >;
  removeRl_infraestructura_unidad_construccions!: Sequelize.HasManyRemoveAssociationsMixin<
    rl_infraestructura_unidad_construccion,
    rl_infraestructura_unidad_construccionId
  >;
  hasRl_infraestructura_unidad_construccion!: Sequelize.HasManyHasAssociationMixin<
    rl_infraestructura_unidad_construccion,
    rl_infraestructura_unidad_construccionId
  >;
  hasRl_infraestructura_unidad_construccions!: Sequelize.HasManyHasAssociationsMixin<
    rl_infraestructura_unidad_construccion,
    rl_infraestructura_unidad_construccionId
  >;
  ...
  setRl_infraestructura_unidad_construccion_inmuebles!: Sequelize.HasManySetAssociationsMixin<
    rl_infraestructura_unidad_construccion_inmueble,
    rl_infraestructura_unidad_construccion_inmuebleId
  >;
  addRl_infraestructura_unidad_construccion_inmueble!: Sequelize.HasManyAddAssociationMixin<
    rl_infraestructura_unidad_construccion_inmueble,
    rl_infraestructura_unidad_construccion_inmuebleId
  >;
  addRl_infraestructura_unidad_construccion_inmuebles!: Sequelize.HasManyAddAssociationsMixin<
    rl_infraestructura_unidad_construccion_inmueble,
    rl_infraestructura_unidad_construccion_inmuebleId
  >;
  ...
  removeRl_infraestructura_unidad_construccion_inmueble!: Sequelize.HasManyRemoveAssociationMixin<
    rl_infraestructura_unidad_construccion_inmueble,
    rl_infraestructura_unidad_construccion_inmuebleId
  >;
  removeRl_infraestructura_unidad_construccion_inmuebles!: Sequelize.HasManyRemoveAssociationsMixin<
    rl_infraestructura_unidad_construccion_inmueble,
    rl_infraestructura_unidad_construccion_inmuebleId
  >;
  hasRl_infraestructura_unidad_construccion_inmueble!: Sequelize.HasManyHasAssociationMixin<
    rl_infraestructura_unidad_construccion_inmueble,
    rl_infraestructura_unidad_construccion_inmuebleId
  >;
  hasRl_infraestructura_unidad_construccion_inmuebles!: Sequelize.HasManyHasAssociationsMixin<
    rl_infraestructura_unidad_construccion_inmueble,
    rl_infraestructura_unidad_construccion_inmuebleId
  >;
  ...
  setRl_infraestructura_unidad_equipo_discapacidads!: Sequelize.HasManySetAssociationsMixin<
    rl_infraestructura_unidad_equipo_discapacidad,
    rl_infraestructura_unidad_equipo_discapacidadId
  >;
  addRl_infraestructura_unidad_equipo_discapacidad!: Sequelize.HasManyAddAssociationMixin<
    rl_infraestructura_unidad_equipo_discapacidad,
    rl_infraestructura_unidad_equipo_discapacidadId
  >;
  addRl_infraestructura_unidad_equipo_discapacidads!: Sequelize.HasManyAddAssociationsMixin<
    rl_infraestructura_unidad_equipo_discapacidad,
    rl_infraestructura_unidad_equipo_discapacidadId
  >;
  ...
  removeRl_infraestructura_unidad_equipo_discapacidad!: Sequelize.HasManyRemoveAssociationMixin<
    rl_infraestructura_unidad_equipo_discapacidad,
    rl_infraestructura_unidad_equipo_discapacidadId
  >;
  removeRl_infraestructura_unidad_equipo_discapacidads!: Sequelize.HasManyRemoveAssociationsMixin<
    rl_infraestructura_unidad_equipo_discapacidad,
    rl_infraestructura_unidad_equipo_discapacidadId
  >;
  hasRl_infraestructura_unidad_equipo_discapacidad!: Sequelize.HasManyHasAssociationMixin<
    rl_infraestructura_unidad_equipo_discapacidad,
    rl_infraestructura_unidad_equipo_discapacidadId
  >;
  hasRl_infraestructura_unidad_equipo_discapacidads!: Sequelize.HasManyHasAssociationsMixin<
    rl_infraestructura_unidad_equipo_discapacidad,
    rl_infraestructura_unidad_equipo_discapacidadId
  >;
  ...
  setRl_infraestructura_unidad_espacio_inmuebles!: Sequelize.HasManySetAssociationsMixin<
    rl_infraestructura_unidad_espacio_inmueble,
    rl_infraestructura_unidad_espacio_inmuebleId
  >;
  addRl_infraestructura_unidad_espacio_inmueble!: Sequelize.HasManyAddAssociationMixin<
    rl_infraestructura_unidad_espacio_inmueble,
    rl_infraestructura_unidad_espacio_inmuebleId
  >;
  addRl_infraestructura_unidad_espacio_inmuebles!: Sequelize.HasManyAddAssociationsMixin<
    rl_infraestructura_unidad_espacio_inmueble,
    rl_infraestructura_unidad_espacio_inmuebleId
  >;
  ...
  removeRl_infraestructura_unidad_espacio_inmueble!: Sequelize.HasManyRemoveAssociationMixin<
    rl_infraestructura_unidad_espacio_inmueble,
    rl_infraestructura_unidad_espacio_inmuebleId
  >;
  removeRl_infraestructura_unidad_espacio_inmuebles!: Sequelize.HasManyRemoveAssociationsMixin<
    rl_infraestructura_unidad_espacio_inmueble,
    rl_infraestructura_unidad_espacio_inmuebleId
  >;
  hasRl_infraestructura_unidad_espacio_inmueble!: Sequelize.HasManyHasAssociationMixin<
    rl_infraestructura_unidad_espacio_inmueble,
    rl_infraestructura_unidad_espacio_inmuebleId
  >;
  hasRl_infraestructura_unidad_espacio_inmuebles!: Sequelize.HasManyHasAssociationsMixin<
    rl_infraestructura_unidad_espacio_inmueble,
    rl_infraestructura_unidad_espacio_inmuebleId
  >;
  ...
  setRl_infraestructura_unidad_espacios_educativos!: Sequelize.HasManySetAssociationsMixin<
    rl_infraestructura_unidad_espacios_educativos,
    rl_infraestructura_unidad_espacios_educativosId
  >;
  addRl_infraestructura_unidad_espacios_educativo!: Sequelize.HasManyAddAssociationMixin<
    rl_infraestructura_unidad_espacios_educativos,
    rl_infraestructura_unidad_espacios_educativosId
  >;
  addRl_infraestructura_unidad_espacios_educativos!: Sequelize.HasManyAddAssociationsMixin<
    rl_infraestructura_unidad_espacios_educativos,
    rl_infraestructura_unidad_espacios_educativosId
  >;
  ...
  removeRl_infraestructura_unidad_espacios_educativo!: Sequelize.HasManyRemoveAssociationMixin<
    rl_infraestructura_unidad_espacios_educativos,
    rl_infraestructura_unidad_espacios_educativosId
  >;
  removeRl_infraestructura_unidad_espacios_educativos!: Sequelize.HasManyRemoveAssociationsMixin<
    rl_infraestructura_unidad_espacios_educativos,
    rl_infraestructura_unidad_espacios_educativosId
  >;
  hasRl_infraestructura_unidad_espacios_educativo!: Sequelize.HasManyHasAssociationMixin<
    rl_infraestructura_unidad_espacios_educativos,
    rl_infraestructura_unidad_espacios_educativosId
  >;
  hasRl_infraestructura_unidad_espacios_educativos!: Sequelize.HasManyHasAssociationsMixin<
    rl_infraestructura_unidad_espacios_educativos,
    rl_infraestructura_unidad_espacios_educativosId
  >;
  ...
  setRl_infraestructura_unidad_fin_inmuebles!: Sequelize.HasManySetAssociationsMixin<
    rl_infraestructura_unidad_fin_inmueble,
    rl_infraestructura_unidad_fin_inmuebleId
  >;
  addRl_infraestructura_unidad_fin_inmueble!: Sequelize.HasManyAddAssociationMixin<
    rl_infraestructura_unidad_fin_inmueble,
    rl_infraestructura_unidad_fin_inmuebleId
  >;
  addRl_infraestructura_unidad_fin_inmuebles!: Sequelize.HasManyAddAssociationsMixin<
    rl_infraestructura_unidad_fin_inmueble,
    rl_infraestructura_unidad_fin_inmuebleId
  >;
  ...
  removeRl_infraestructura_unidad_fin_inmueble!: Sequelize.HasManyRemoveAssociationMixin<
    rl_infraestructura_unidad_fin_inmueble,
    rl_infraestructura_unidad_fin_inmuebleId
  >;
  removeRl_infraestructura_unidad_fin_inmuebles!: Sequelize.HasManyRemoveAssociationsMixin<
    rl_infraestructura_unidad_fin_inmueble,
    rl_infraestructura_unidad_fin_inmuebleId
  >;
  hasRl_infraestructura_unidad_fin_inmueble!: Sequelize.HasManyHasAssociationMixin<
    rl_infraestructura_unidad_fin_inmueble,
    rl_infraestructura_unidad_fin_inmuebleId
  >;
  hasRl_infraestructura_unidad_fin_inmuebles!: Sequelize.HasManyHasAssociationsMixin<
    rl_infraestructura_unidad_fin_inmueble,
    rl_infraestructura_unidad_fin_inmuebleId
  >;
  ...
  setRl_infraestructura_unidad_obra_mantenimientos!: Sequelize.HasManySetAssociationsMixin<
    rl_infraestructura_unidad_obra_mantenimiento,
    rl_infraestructura_unidad_obra_mantenimientoId
  >;
  addRl_infraestructura_unidad_obra_mantenimiento!: Sequelize.HasManyAddAssociationMixin<
    rl_infraestructura_unidad_obra_mantenimiento,
    rl_infraestructura_unidad_obra_mantenimientoId
  >;
  addRl_infraestructura_unidad_obra_mantenimientos!: Sequelize.HasManyAddAssociationsMixin<
    rl_infraestructura_unidad_obra_mantenimiento,
    rl_infraestructura_unidad_obra_mantenimientoId
  >;
  ...
  removeRl_infraestructura_unidad_obra_mantenimiento!: Sequelize.HasManyRemoveAssociationMixin<
    rl_infraestructura_unidad_obra_mantenimiento,
    rl_infraestructura_unidad_obra_mantenimientoId
  >;
  removeRl_infraestructura_unidad_obra_mantenimientos!: Sequelize.HasManyRemoveAssociationsMixin<
    rl_infraestructura_unidad_obra_mantenimiento,
    rl_infraestructura_unidad_obra_mantenimientoId
  >;
  hasRl_infraestructura_unidad_obra_mantenimiento!: Sequelize.HasManyHasAssociationMixin<
    rl_infraestructura_unidad_obra_mantenimiento,
    rl_infraestructura_unidad_obra_mantenimientoId
  >;
  hasRl_infraestructura_unidad_obra_mantenimientos!: Sequelize.HasManyHasAssociationsMixin<
    rl_infraestructura_unidad_obra_mantenimiento,
    rl_infraestructura_unidad_obra_mantenimientoId
  >;
  ...
  ): typeof ct_infraestructura_unidad {
        ...
        indexes: [
          {
            ...
            unique: true,
            using: "BTREE",
            fields: [{ name: "id_unidad" }],
          },
          {
            name: "id_razon_no_construccion",
            using: "BTREE",
            fields: [{ name: "id_razon_no_construccion" }],
          },
          {
            name: "id_antiguedad_inmueble",
            using: "BTREE",
            fields: [{ name: "id_antiguedad_inmueble" }],
          },
          {
            name: "id_dimension_terreno",
            using: "BTREE",
            fields: [{ name: "id_dimension_terreno" }],
          },
          {
            name: "id_suministro_agua",
            using: "BTREE",
            fields: [{ name: "id_suministro_agua" }],
          },
          {
            name: "id_suministro_energia",
            using: "BTREE",
            fields: [{ name: "id_suministro_energia" }],
          },
          {
            name: "id_suministro_gas",
            using: "BTREE",
            fields: [{ name: "id_suministro_gas" }],
          },
          {
            name: "id_tipo_descarga",
            using: "BTREE",
            fields: [{ name: "id_tipo_descarga" }],
          },
          {
            name: "id_frecuencia_limpieza",
            using: "BTREE",
            fields: [{ name: "id_frecuencia_limpieza" }],
          },
        ],
      }
    );
