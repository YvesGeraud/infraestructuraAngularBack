...
export class ct_infraestructura_unidad extends Model<ct_infraestructura_unidadAttributes, ct_infraestructura_unidadCreationAttributes> implements ct_infraestructura_unidadAttributes {
  ...
  // ct_infraestructura_unidad belongsToMany ct_infraestructura_espacio_educativo via id_unidad and id_espacio
  id_espacio_ct_infraestructura_espacio_educativos!: ct_infraestructura_espacio_educativo[];
  getId_espacio_ct_infraestructura_espacio_educativos!: Sequelize.BelongsToManyGetAssociationsMixin<ct_infraestructura_espacio_educativo>;
  setId_espacio_ct_infraestructura_espacio_educativos!: Sequelize.BelongsToManySetAssociationsMixin<ct_infraestructura_espacio_educativo, ct_infraestructura_espacio_educativoId>;
  addId_espacio_ct_infraestructura_espacio_educativo!: Sequelize.BelongsToManyAddAssociationMixin<ct_infraestructura_espacio_educativo, ct_infraestructura_espacio_educativoId>;
  addId_espacio_ct_infraestructura_espacio_educativos!: Sequelize.BelongsToManyAddAssociationsMixin<ct_infraestructura_espacio_educativo, ct_infraestructura_espacio_educativoId>;
  createId_espacio_ct_infraestructura_espacio_educativo!: Sequelize.BelongsToManyCreateAssociationMixin<ct_infraestructura_espacio_educativo>;
  removeId_espacio_ct_infraestructura_espacio_educativo!: Sequelize.BelongsToManyRemoveAssociationMixin<ct_infraestructura_espacio_educativo, ct_infraestructura_espacio_educativoId>;
  removeId_espacio_ct_infraestructura_espacio_educativos!: Sequelize.BelongsToManyRemoveAssociationsMixin<ct_infraestructura_espacio_educativo, ct_infraestructura_espacio_educativoId>;
  hasId_espacio_ct_infraestructura_espacio_educativo!: Sequelize.BelongsToManyHasAssociationMixin<ct_infraestructura_espacio_educativo, ct_infraestructura_espacio_educativoId>;
  hasId_espacio_ct_infraestructura_espacio_educativos!: Sequelize.BelongsToManyHasAssociationsMixin<ct_infraestructura_espacio_educativo, ct_infraestructura_espacio_educativoId>;
  countId_espacio_ct_infraestructura_espacio_educativos!: Sequelize.BelongsToManyCountAssociationsMixin;
